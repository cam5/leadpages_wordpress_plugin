/*
 ...
 Source Database       : wordpress_test

 Target Server Type    : MySQL
 Target Server Version : 50542
 File Encoding         : utf-8

 Date: 09/20/2016 12:26:23 PM
*/
...
-- ----------------------------
--  Table structure for `wptests_commentmeta`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `wptests_comments`
-- ----------------------------
...
-- ----------------------------
--  Records of `wptests_comments`
-- ----------------------------
BEGIN;
INSERT INTO `wptests_comments` VALUES ('1', '1', 'A WordPress Commenter', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2016-09-20 17:23:31', '2016-09-20 17:23:31', 'Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.', '0', '1', '', '', '0', '0');
COMMIT;

-- ----------------------------
--  Table structure for `wptests_links`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `wptests_options`
-- ----------------------------
...
-- ----------------------------
--  Records of `wptests_postmeta`
-- ----------------------------
BEGIN;
INSERT INTO `wptests_postmeta` VALUES ('1', '2', '_wp_page_template', 'default');
COMMIT;

-- ----------------------------
--  Table structure for `wptests_posts`
-- ----------------------------
...
-- ----------------------------
--  Records of `wptests_posts`
-- ----------------------------
BEGIN;
INSERT INTO `wptests_posts` VALUES ('1', '1', '2016-09-20 17:23:31', '2016-09-20 17:23:31', 'Welcome to WordPress. This is your first post. Edit or delete it, then start writing!', 'Hello world!', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2016-09-20 17:23:31', '2016-09-20 17:23:31', '', '0', 'http://localhost:8888/wordpress_unit_test/?p=1', '0', 'post', '', '1'), ('2', '1', '2016-09-20 17:23:31', '2016-09-20 17:23:31', 'This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href=\"http://localhost:8888/wordpress_unit_test/wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!', 'Sample Page', '', 'publish', 'closed', 'open', '', 'sample-page', '', '', '2016-09-20 17:23:31', '2016-09-20 17:23:31', '', '0', 'http://localhost:8888/wordpress_unit_test/?page_id=2', '0', 'page', '', '0');
COMMIT;

-- ----------------------------
--  Table structure for `wptests_term_relationships`
-- ----------------------------
...
-- ----------------------------
--  Records of `wptests_term_relationships`
-- ----------------------------
BEGIN;
INSERT INTO `wptests_term_relationships` VALUES ('1', '1', '0');
COMMIT;

-- ----------------------------
--  Table structure for `wptests_term_taxonomy`
-- ----------------------------
...
-- ----------------------------
--  Records of `wptests_term_taxonomy`
-- ----------------------------
BEGIN;
INSERT INTO `wptests_term_taxonomy` VALUES ('1', '1', 'category', '', '0', '1');
COMMIT;

-- ----------------------------
--  Table structure for `wptests_termmeta`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `wptests_terms`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `wptests_usermeta`
-- ----------------------------
...
-- ----------------------------
--  Records of `wptests_usermeta`
-- ----------------------------
BEGIN;
INSERT INTO `wptests_usermeta` VALUES ('1', '1', 'nickname', 'admin'), ('2', '1', 'first_name', ''), ('3', '1', 'last_name', ''), ('4', '1', 'description', ''), ('5', '1', 'rich_editing', 'true'), ('6', '1', 'comment_shortcuts', 'false'), ('7', '1', 'admin_color', 'fresh'), ('8', '1', 'use_ssl', '0'), ('9', '1', 'show_admin_bar_front', 'true'), ('10', '1', 'wptests_capabilities', 'a:1:{s:13:\"administrator\";b:1;}'), ('11', '1', 'wptests_user_level', '10'), ('12', '1', 'dismissed_wp_pointers', ''), ('13', '1', 'show_welcome_panel', '1');
COMMIT;

-- ----------------------------
--  Table structure for `wptests_users`
-- ----------------------------
...
-- ----------------------------
--  Records of `wptests_users`
-- ----------------------------
BEGIN;
INSERT INTO `wptests_users` VALUES ('1', 'admin', '$P$BkIAGSx1XBla9IOjjDgeiyKCvbd3uq/', 'admin', 'brandon.braner@ave81.com', '', '2016-09-20 17:23:31', '', '0', 'admin');
COMMIT;
